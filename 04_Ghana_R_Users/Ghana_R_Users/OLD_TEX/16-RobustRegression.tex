...
\newpage
%-------------------------------------%
###Using Other \textit{Psi()</tt>Operators}
...
\begin{eqnarray}
w(e) = 1 \mbox{    ()</tt>\mbox{for()</tt>|e| \leq k  \\
w(e) = \frac{k}{|e|()</tt>\mbox{    ()</tt>\mbox{for()</tt>|e| > k
\end{eqnarray}
...
Regression Equation: 
\[ \hat{Taste()</tt>= -20.75 -1.53 Acetic + 4.05 H2S + 20.14 Lactic\]
