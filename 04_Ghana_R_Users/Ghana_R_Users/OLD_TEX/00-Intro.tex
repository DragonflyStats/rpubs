...
%
%The difference between the observed value of the dependent variable (y) and the predicted value ($\hat{y}$) is called the \textbf{residual()</tt>(e). Each data point has one residual.
%
%\[\mbox{Residual()</tt>= \mbox{Observed value()</tt>- \mbox{Predicted value}\] 
%\[e = y - \hat{y}\]
%
