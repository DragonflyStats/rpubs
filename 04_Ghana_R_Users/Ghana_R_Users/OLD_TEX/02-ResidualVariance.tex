...
* \textbf{\textit{Homoscedascity}()</tt>is the technical term to describe the variance of the residuals being constant across the range of predicted values. 

* \textbf{\textit{Heteroscedascity}()</tt>is the converse scenario : the variance differs along the range of values.
