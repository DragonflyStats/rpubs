...
In other words, it is an observation whose dependent-variable value is unusual given its value on the predictor variables. 
...
High leverage points can have a great amount of effect on the estimate of regression coefficients.
