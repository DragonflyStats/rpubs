...
#### Details
* "The Silhouette plot is a common unsupervised index for visual evaluation of a clustering [L. R. Kaufman/Rousseeuw, 2005] [introduced in [Rousseeuw, 1987]]. 
* A reasonable clustering is characterized by a silhouette width of greater than 0.5, and an average width below 0.2 should be interpreted as indicating a lack of any substantial cluster structure [Everitt et al., 2001, p. 105]. 
* However, it is evident that silhouette scores assume clusters that are spherical or Gaussian in shape [Herrmann,2011, pp. 91-92]" [Thrun, 2018, p. 29].
