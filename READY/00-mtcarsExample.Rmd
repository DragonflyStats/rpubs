...
* Several data sets , intended as learning tools, are automatically installed when <tt>R</tt> is installed. 
* Many more are installed within packages to complement learning to use those packages. 
* One of these is the famous ***mtcars*** data set, which is used in many data mining exercises.
