...
\begin{itemize} 
*  The optional command \texttt{ratio} is the null hypothesis; the default value is 1 if not specified. 
*  The command \texttt{alternative} gives the alternative hypothesis should the experimental F-ratio is found to be significantly 
different than that specified by ratio. 
*  The default for alternative is “two-sided” with the 
other possible choices being “less” or “greater.” 
*  The command \texttt{conf.level;} gives the confidence level to be used in the test; the default value of 0.95 is equivalent to α = 0.05. 
\end{itemize}
