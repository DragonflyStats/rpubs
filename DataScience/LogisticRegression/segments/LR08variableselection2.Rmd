...
* [1] \textbf{Enter}. A procedure for variable selection in which all variables in a block are entered in a
single step.
* [2] \textbf{Forward Selection (Conditional)}. Stepwise selection method with entry testing based on
...
* [3] \textbf{Forward Selection (Likelihood Ratio)}. Stepwise selection method with entry testing based
...
* [4] \textbf{Forward Selection (Wald)}. Stepwise selection method with entry testing based on the
significance of the score statistic, and removal testing based on the probability of the Wald
statistic.
* [5] \textbf{Backward Elimination (Conditional)}. Backward stepwise selection. \\ Removal testing is based on
the probability of the likelihood-ratio statistic based on conditional parameter estimates.
* [6] \textbf{Backward Elimination (Likelihood Ratio)}. Backward stepwise selection. \\ Removal testing
is based on the probability of the likelihood-ratio statistic based on the maximum partial
likelihood estimates.
* [7] \textbf{Backward Elimination (Wald)}. Backward stepwise selection. \\ Removal testing is based on the
