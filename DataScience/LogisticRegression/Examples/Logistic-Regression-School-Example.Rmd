...
\end{verbatim}
<p>
## Interpreting the \texttt{Summary} output}
...
*  Now that we have the data frame we want to use to calculate the predicted probabilities, we can tell \texttt{R} to create the predicted probabilities. 
...
%----------------------------------------------------------%
## Another Prediction Example - (optional)}
