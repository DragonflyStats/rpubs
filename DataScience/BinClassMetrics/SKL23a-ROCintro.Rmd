...
\textbf{Evaluating Models with ROC Curves}
...
\[ \mbox{FPR}=\frac{\mbox{False Positives}}{\mbox{False Positives + True Negatives} }\]
 ...
 \textit{\textbf{Remark} True Positives Rates and True Negatives Rates referred to as Sensitivity and Specificity.}
%
% *  You might have heard of.
%*   No matter what you call it, the big point here is we're measuring the trade off between the rate at which you can correctly predict something, with the rate at which you make an embarrassing blunder and predict something that doesn't happen.
%
%-------------------------------------------------------------------------- %
...
%--------------------------------------------------------------------------- %
 ...
 \textbf{Scenarios: Guessing at Random}
...
\\
 \textit{For review: The Area Under the Curve (AUC)  is 0.500.} 

 \textbf{A Perfect Classifier}
...
\end{figure}
\begin{framed}
 \textbf{Important:} The better your classifier, the more closer the curve will be to the top left corner.
\end{framed}
