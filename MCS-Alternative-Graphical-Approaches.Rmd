...
for each ranked difference between methods. Folded plots are so-called because all percentiles above 50 are transformed to the difference of that percentile and 100 (e\.g. the 81st percentile is transformed to the 19th percentile). These percentiles are then plotted against the differences between the two methods.
